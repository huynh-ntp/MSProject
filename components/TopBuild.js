...
export default class TopBuild extends Component {
    render() {
        const { pc, detail } = this.props;
        const totalPrice = pc.CPU.price + pc.main.price + pc.VGA.price + pc.PSU.price + pc.ram.price + pc.case.price;
        ...
        return (
            <TouchableOpacity onPress={detail} style={styles.container} activeOpacity="0.6">
                ...
                <View style={{ paddingVertical: 15, width: 210 }}>
